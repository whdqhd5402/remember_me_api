...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { alias: @day.alias, seq: @day.seq, trip_id: @day.trip_id } }, as: :json
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { alias: @day.alias, seq: @day.seq, trip_id: @day.trip_id } }, as: :json
    assert_response 200
  end
